              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <div class="col-sm-6 col-xs-6 col-md-4 ">
                      <a href="" data-toggle="modal" data-target="#add-stock"><img width="100px"  src="img/ingreso.png"></a>
                    </div>
                    <div class="col-sm-6 col-xs-6 col-md-4">
                      <a href="" data-toggle="modal" data-target="#remove-stock"><img width="100px"  src="img/egreso.png"></a>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
                    </div>
